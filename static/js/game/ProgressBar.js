...
ProgressBar.prototype.start = function() {
	...
	this.seconds = (DEVELOPER_MODE === true && developer.settings.speedUp) ? 1 : this.task.response.queue.secondsLeft;
	this.step = this.seconds * 10;

	this.progress = (function() {
		var i = instance;
		return function() {
			var val = i.p.progressbar("value") || 0;
			i.p.progressbar("value", val + 1);
		};
	})(instance);


	this.thread = setInterval(this.progress, this.step);
};