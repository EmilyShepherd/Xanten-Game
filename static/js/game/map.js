				...
				if (imgArray[y][x] !== "o") {
					...
					if ((n && (e || se)) || (e && nw)){
						if (x === 0 && y === 6) {
							...
							if ((imgArray[y+1][x-1] === "o-e" || imgArray[y+1][x-1] === "ob-ne" || imgArray[y+1][x-1] === "oc-se" || imgArray[y+1][x-1] === "oa-nw") && (imgArray[y][x-1] === "o-n" || imgArray[y][x-1] === "ob-nw" || imgArray[y][x-1] === "oc-ne" || imgArray[y][x-1] === "oa-ne")) {
								imgArray[y][x] = "ob-ne";
							}
						}
					}
